...
/**
 * KraftModularPage - Original KRAFT_AI Terminal style with true three-column layout
 * 
 * This page implements:
 * - First column: Top-level categories/modules
 * - Second column: Items within the selected category
 * - Third column: Active document content
 */
export default function KraftModularPage() {
