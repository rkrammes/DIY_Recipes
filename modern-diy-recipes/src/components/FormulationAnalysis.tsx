...
import type { FormulationAnalysisData } from '../types/models';

interface FormulationAnalysisProps {
  analysisData: FormulationAnalysisData | null;
}

export default function FormulationAnalysis({ analysisData }: FormulationAnalysisProps) {
  if (!analysisData) {
  ...
  return (
    <div className="bg-[var(--surface-0)] text-[var(--text-primary)] p-4 rounded-lg shadow-md mt-4 border border-[var(--border-subtle)]">
      <h3 className="text-lg font-semibold mb-4 text-[var(--text-primary)]">Formulation Analysis</h3>
